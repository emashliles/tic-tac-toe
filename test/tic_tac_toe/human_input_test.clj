...
(deftest get-user-selection (is (= "1" 
  (with-in-str "2" (get-human-selection)) )))

(deftest negative-selection-invalid (with-out-str (is (= "0" 
  (with-in-str "-1\n1\n" (get-human-selection))))))

(deftest non-number-invalid (with-out-str (is (= "0" 
  (with-in-str "hello\n1\n" (get-human-selection))))))
